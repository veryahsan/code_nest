...
Rails.application.configure do
  ...
  # Force browsers to revalidate every static asset in development so CSS/JS
  # edits never appear "not applied". `no-cache` (alone) is the modern,
  # standards-compliant way to require revalidation without disabling the
  # cache outright. This intentionally overrides the long max-age Rails sets
  ...
  # Use letter_opener to preview emails locally instead of sending them.
